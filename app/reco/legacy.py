"""Legacy recommendation helpers used by calculators and quizzes."""
...
CTX = {
    ...
    "deficit_high": {
        ...
        "D3": "Обсуди оптимальную дозировку D3 для восстановления уровн.",
    },
    "skin_joint_low": {
...
def product_lines(codes: List[str], context: str) -> List[str]:
    ...
    for code in codes:
        ...
        title = meta.get("name") if meta else code
        generic = ""
        if meta:
            generic = meta.get("short") or meta.get("name") or code
