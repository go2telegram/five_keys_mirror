...
GUT_QUESTIONS = [
    ...
    (
        "Стул нерегулярный (реже 1 раза в день / запоры / нестабильный)?",
        [("Нет", 0), ("Иногда", 2), ("Да", 4)],
    ),
    (
        "Тянет на сладкое/перекусы, сложно контролировать аппетит?",
        [("Нет", 0), ("Иногда", 2), ("Да", 4)],
    ),
    (
        "Недавно были антибиотики/острые инфекции/стрессы?",
        [("Нет", 0), ("За 3–6 мес", 2), ("За последний месяц", 4)],
    ),
